...
let API = (function() {
	...
	API.prototype.patch_challenge = function(parameters) {
		...
		if (parameters["challengeId"] === undefined) {
			deferred.reject(
				new Error("Missing required  parameter: challengeId")
			);
			return deferred.promise;
		}
	...
	API.prototype.patch_config = function(parameters) {
		...
		if (parameters["configKey"] === undefined) {
			deferred.reject(
				new Error("Missing required  parameter: configKey")
			);
			return deferred.promise;
		}
	...
	API.prototype.delete_notification = function(parameters) {
		...
		if (parameters["notificationId"] === undefined) {
			deferred.reject(
				new Error("Missing required  parameter: notificationId")
			);
			return deferred.promise;
		}
	...
	API.prototype.get_scoreboard_detail = function(parameters) {
		...
		let deferred = Q.defer();
		let domain = this.domain;
		let path = "/scoreboard/top/{count}";
		if (window.location.pathname.includes("/scoreboard-all")) {
			path = "/scoreboard/top-hidden/{count}";
		}
		let body = {},
			queryParameters = {},
			headers = {},
	...
	API.prototype.delete_submission = function(parameters) {
		...
		if (parameters["submissionId"] === undefined) {
			deferred.reject(
				new Error("Missing required  parameter: submissionId")
			);
			return deferred.promise;
		}
